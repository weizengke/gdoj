  	...
  	<a href="admin">Admin</a>
	    ...
	    <div class="content round_0123" style="background-color:#EEE0E5;padding:3px 3px 3px 3px;">	    	
			<div class="datatable round_0123" style="background-color:#FFF;word-wrap:break-word;">
			    <s:form id="addcontest" method="post" action="addcontest.action"  theme="simple">
					...
					<input style="width: 24px" class="sminute" name="sminute"  value=<s:property value="sminute"/>>MM<span class="fielderror"><s:fielderror ><s:param>start_date</s:param></s:fielderror></span>
					<br/>
					...
					<input style="width: 24px" class="eminute" name="eminute"  value=<s:property value="eminute"/>>MM<span class="fielderror"><s:fielderror ><s:param>end_date</s:param></s:fielderror></span>
					<br/>
					...
					<select id="type"  style= "width:150px" name="contest.type">
						...
						<option value="1" >Google Code Jam</option>
					</select>	</h5>
					<h5>
					Password:
					</h5>
			    	...
			    	<div style="text-align: center;margin: 12px;">	
			    		<input id="add" type="Submit" value="Add Contest"/>
			    	</div>	
			    </s:form>
