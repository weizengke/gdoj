	 ...
	 <div id="problem-box">
	    <div id="problem-box-left" >	
	 		<div id="problem-box-nav" class="problem-second-nav">
				<ul class="hleft">
					<li class="nav_menu"><a class="" href="contest/<s:property value="contestId"/>"><s:text name="contestproblems"/></a></li>
					<li id="problem-box-nav-content" class="nav_menu current"><span><s:text name="problem.description"/></span></li>
					<li id="problem-box-nav-status" class="nav_menu"><span><s:text name="problem.mysubmit"/></span></li>
					<li class="nav_menu"><a href="contest/<s:property value="contestId"/>/standings" target="blank"><s:text name="problem.contest_standings"/></a></li>
				</ul>
				<ul class="hright">
				...
				<div id="problem-status" class="problem-status">
					<div class="roundbox" style="">
						<div class="roundbox-title">
							<div class="left"><s:property value="num"/>.<s:property value="problem.title"/></div>
							<div class="right">
								<span><a style="margin-right: 6px;font-size:10px;color:grey;text-decoration:none;" href="contest/<s:property value="contestId"/>/status/problem/<s:property value="num"/>/page/1"><s:text name="problem.all_submit"/></a></span>
							</div>
						</div>
						<div class="" style="">
	 	...
	 	<div id="problem-box-right">
			<div id="ide-box-nav" class="ide-second-nav">
				...
				<input type="hidden" id="contestId" name="contestId" value="<s:property value="contestId"/>"/>
