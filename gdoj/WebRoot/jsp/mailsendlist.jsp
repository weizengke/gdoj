					...
					<div >
						<table class="mails rtable">
							...
							<tr <s:if test="#st.odd">class="dark"</s:if>>
								...
								<td class="sender">
								<b><a href="profile/<s:property value="to_user"/>" class="rated-user user-rate-<s:property value="recvUser.rate" default="0"/> user-tip" user="<s:property value="to_user"/>">
